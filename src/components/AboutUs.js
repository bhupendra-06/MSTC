    ...
    <div>
      ...
      >
        <div className="py-4 max-w-md">
          ...
          <h3 className="text-4xl font-bold pb-4 leading-normal">
            India's best{" "}
          ...
          <p className="pb-5">
            We are commited to providing personalized tuition classes that cater
            to the unique learning needs for each student.
          </p>
          <h3 className="text-xl font-semibold pb-2">
            {" "}
            <GiCheckMark className="inline text-green-500 text-2xl mb-2" />{" "}
            Expert Teachers
          </h3>
          <h3 className="text-xl font-semibold pb-2">
            {" "}
      ...
      <div className="max-w-6xl mx-auto mt-10 py-6 mb-12">
        <div className="flex flex-wrap justify-evenly gap-7">
          <div className="bg-white px-8 py-6 rounded-lg min-w-64 shadow-[0_0.5rem_1rem_rgba(0,0,0,0.15)]">
            <h2 className="text-4xl font-bold text-center pb-1 text-[#FFC834]">
              15496+
            </h2>
            <p className="text-center text-[#5C5C5C]">
              HAPPY PARENTS/STUDENTS{" "}
            </p>
          </div>
          <div className="bg-white px-8 py-6 rounded-lg min-w-64 shadow-[0_0.5rem_1rem_rgba(0,0,0,0.15)]">
            <h2 className="text-4xl font-bold text-center pb-1 text-[#f8771e]">
              1.3M
            </h2>
            <p className="text-center text-[#5C5C5C]">CLASS COMPLETED</p>
          </div>
          <div className="bg-white px-8 py-6 rounded-lg min-w-64 shadow-[0_0.5rem_1rem_rgba(0,0,0,0.15)]">
            <h2 className="text-4xl font-bold text-center pb-1 text-[#13f59a]">
              100%
            </h2>
            <p className="text-center text-[#5C5C5C]">SATISFACTION RATE</p>
          </div>
          <div className="bg-white px-8 py-6 rounded-lg min-w-64 shadow-[0_0.5rem_1rem_rgba(0,0,0,0.15)]">
            <h2 className="text-4xl font-bold text-center pb-1 text-[#63aaff]">
              9875
            </h2>
